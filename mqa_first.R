...
summary(populacao_local1$renda)
summary(populacao_local2$renda)
...
boxplot(
  ...
  names = c("Monte Verde", "Parque do Engenho", "Encosta do Morro"),
  ylab = "Quantidade de Salários Mínimos",
  xlab = "Locais",
  main = "Local x Quantidade de Salários Mínimos"
  )